...
// ************************************************** //
		  ...
		  out <<  "* Upper Bound: Relax-and-Fix procedure (time-oriented decomposition)" << endl;
...
//      with Time-Oriented Decomposition      //
// ****************************************** //
		 ...
		 //For each time-window the whole set of final products, pieces is considered 
		 //and the resulting ILSSCS problem is solved by an optimization package (CPLEX)
		 ...
		 int T_int_begin, T_int_end;																//interval of periods where the setup variables are integer
		 ...
		 // ****************************************************************************************
		 //Assigning the main values to the Relax-and-Fix
		 ...
		 for(; ;){
				 ...
				 for(t=T_int_begin; t < (T_int_begin+T_Fix); t++)
				  ...
				  //Move the time-window in the Relax-and-Fix procedure
